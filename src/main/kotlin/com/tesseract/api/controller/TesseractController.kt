...
class TesseractController(tesseractService: TesseractService? = null, utilService: UtilService? = null)
{
    ...
    val tesseractService = tesseractService?: TesseractService()
    ...
    fun getLanguages(): ResponseEntity<WrappedResponse<List<TesseractLanguage>>>
    {
        return try
        {
            val list = tesseractService.getInstalledLanguages()
                  ...
                  engineMode: OcrEngineMode): ResponseEntity<WrappedResponse<TesseractResultDto>>
    {
        return try
        {
            ...
            val lang = tesseractService.getTesseractLanguage(languageKey)
                ?: return ResponseEntity.status(400).body(
            ...
            val res = tesseractService.processImage(
